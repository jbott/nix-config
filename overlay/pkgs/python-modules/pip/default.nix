# Remove once pip-tools passes checks on nixos-unstable again
# Vendored from:
#   https://github.com/NixOS/nixpkgs/blob/b1c95fb843374ca29684b89009a54955a22db8c5/pkgs/development/python-modules/pip/default.nix
{
  lib,
  buildPythonPackage,
  fetchFromGitHub,
